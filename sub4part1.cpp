...
int main(){
    ...
    for(int i=0;i<N;i++){
        ...
        */
        ...
        //tired for this now
        int w_score = Wpawn.size()*100 + Wsuperpawn.size()*350 + Wgirafe.size()*400 + Wzebra.size()*300;

        int b_score = Bpawn.size()*100 + Bsuperpawn.size()*350 + Bgirafe.size()*400 + Bzebra.size()*300;
